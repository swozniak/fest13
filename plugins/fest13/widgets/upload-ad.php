<?php
class wp_fest13_upload_ad_widget extends WP_Widget {
	// constructor
	function wp_fest13_upload_ad_widget() {
        parent::WP_Widget( false, 
        	$name = __( 'Fest13 - Display Ad', 'wp_widget_plugin' ), 
        	array( 'description' => __( 'Upload an ad', 'text_domain' ), ) );
	}
	...
	public function form( $instance ) {
		...
		?>
		<p>
      <label for="<?php echo $this->get_field_id('name'); ?>"><?php _e('Title (Optional)', 'iuw'); ?></label><br />
...
function bind_media_gallery() {
  wp_enqueue_media();
  wp_enqueue_script( 'widget-uploadAd', plugins_url( '/upload-ad.js' , __FILE__ ) );
}
add_action('admin_enqueue_scripts', 'bind_media_gallery');