	...
	<div class="container">
	  <header>
		...
		<div class="row" id="fest-splash">
		  <a href="<?php bloginfo( 'url' ); ?>"><img class="img-responsive" src="<?php bloginfo('template_directory'); ?>/img/fest_splash.jpg" /></a>
		</div>
		...
		<nav class="navbar navbar-default" id="fest-nav" role="navigation">
		  <div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="fest-nav-collapse">
			  <?php wp_nav_menu( array( 'theme_location' => 'fest-nav-1', 'menu_id' => 'fest-nav-1', 'menu_class' => 'nav navbar-nav navbar-right', 'depth'=> 3, 'container'=> false, 'walker'=> new Bootstrap_Walker_Nav_Menu ) ); ?>
			  <?php wp_nav_menu( array( 'theme_location' => 'fest-nav-2', 'menu_id' => 'fest-nav-2', 'menu_class' => 'nav navbar-nav navbar-right', 'depth'=> 3, 'container'=> false, 'walker'=> new Bootstrap_Walker_Nav_Menu ) ); ?>
			  <?php wp_nav_menu( array( 'theme_location' => 'fest-nav-3', 'menu_id' => 'fest-nav-3', 'menu_class' => 'nav navbar-nav navbar-right', 'depth'=> 3, 'container'=> false, 'walker'=> new Bootstrap_Walker_Nav_Menu ) ); ?>
			</div>
		  </div>
		</nav>
	  </header>
