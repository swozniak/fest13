...
class WC_Gateway_Authorize_Net_CIM extends WC_Payment_Gateway {
	...
	<fieldset>
		...
		<div<?php echo ( isset( $has_cards ) && $has_cards ) ? ' class="authorize-net-cim-new-saved-credit-card"' : ''; ?>>
			<p class="form-row">
				<label for="authorize-net-cim-cc-number"><?php _e( "Credit Card Number", WC_Authorize_Net_CIM::TEXT_DOMAIN); ?> <span class="required">*</span></label>
				<input type="text" class="input-text" id="authorize-net-cim-cc-number" name="authorize-net-cim-cc-number" maxlength="19" autocomplete="off" />
			</p>
			<div class="clear"></div>

			<p class="form-row form-row-first">
				<label for="authorize-net-cim-cc-exp-month"><?php _e( "Expiration Date", WC_Authorize_Net_CIM::TEXT_DOMAIN ); ?> <span class="required">*</span></label>
		...
		<p class="form-row form-row-last" id="authorize-net-cim-cc-cvv-section">
			<label for="authorize-net-cim-cc-cvv"><?php _e( "Card Security Code", WC_Authorize_Net_CIM::TEXT_DOMAIN ) ?> <span class="required">*</span></label>
			<input type="text" class="input-text" id="authorize-net-cim-cc-cvv" name="authorize-net-cim-cc-cvv" maxlength="4" style="width:60px" autocomplete="off" />
		</p>
