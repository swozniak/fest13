...
<tr class="wc-custom-order-field">
	...
	<td class="wc-custom-order-field-type">
		<select name="wc-custom-order-field-type[<?php echo $index; ?>]" class="js-wc-custom-order-field-type chosen_select" style="width: 100px;">
	...
	<td class="wc-custom-order-field-default-values">
		...
		<img class="help_tip" width="16" height="16"  data-tip='<?php _e( 'Use Pipe (|) to separate options and surround options with double stars (**) to set as a default.', WC_Admin_Custom_Order_Fields::TEXT_DOMAIN ); ?>' src="<?php echo SV_WC_Plugin_Compatibility::WC()->plugin_url(); ?>/assets/images/help.png" />
	</td>
	<td class="wc-custom-order-field-attributes">
		<select name="wc-custom-order-field-attributes[<?php echo $index; ?>][]" class="js-wc-custom-order-field-attributes chosen_select" multiple="multiple">
	...
	<td class="js-wc-custom-order-field-draggable">
		<img src="<?php echo $GLOBALS['wc_admin_custom_order_fields']->get_plugin_url() ?>/assets/images/draggable-handle.png" />
	</td>
</tr>
